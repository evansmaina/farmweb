                    ...
                    <div class="row text-center">
                        <div class="col-sm-10 mx-auto">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" id="name" type="text" placeholder="type of crop">
                            </div>
                        </div>
                        <!--                  end of div-->
                        <div class="col-sm-10 mx-auto">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" id="name" type="text" placeholder="name of crop">
                            </div>
                        </div>
                        <!--                  end of div-->
                        <div class="col-sm-10 mx-auto">
